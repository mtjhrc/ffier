# Contributing to ffier

Thank you for your interest in contributing to ffier! This document
...
```
schema: fix trait_impl methods carrying bogus index/has_default
gen-rust-client: emit Default impl for zero-param constructors
gen-c-header: don't panic when no method uses &[u8]
...
— please replace them with `Assisted-by`.
