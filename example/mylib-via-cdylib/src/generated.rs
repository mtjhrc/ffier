...
unsafe extern "C" {
    fn mylib_error_result(err: *mut core::ffi::c_void) -> ffier::FfierResult;
    fn mylib_error_destroy(err: *mut core::ffi::c_void);
}
...
unsafe extern "C" {
    ...
    pub fn mylib_calculator_add(
        ...
        a: <i32 as FfiType>::CRepr,
        b: <i32 as FfiType>::CRepr,
...
impl Calculator {
    ...
    pub fn add(&self, a: i32, b: i32) -> i32 {
        let __raw = unsafe {
            mylib_calculator_add(
                self.0,
                <i32 as FfiType>::into_c(a),
                <i32 as FfiType>::into_c(b),
            )
        };
    ...
    pub fn is_positive(&self, value: i32) -> bool {
        let __raw =
            unsafe { mylib_calculator_is_positive(self.0, <i32 as FfiType>::into_c(value)) };
...
unsafe extern "C" {
    ...
    pub fn mylib_text_buffer_new(
        output_fd: <OwnedFd as FfiType>::CRepr,
    ) -> <TextBuffer as FfiType>::CRepr;
    pub fn mylib_text_buffer_fd(
        handle: *mut core::ffi::c_void,
    ) -> <BorrowedFd<'static> as FfiType>::CRepr;
    pub fn mylib_text_buffer_write(
        handle: *mut core::ffi::c_void,
        text: <&'static str as FfiType>::CRepr,
    );
...
impl TextBuffer {
    ...
    pub fn write_parts(&mut self, parts: &[&str]) {
        let __ffi_parts: Vec<ffier::FfierBytes> = parts
            .iter()
    ...
    pub fn flush(&self) -> Result<(), BufferError> {
        let mut __err: *mut core::ffi::c_void = core::ptr::null_mut();
        let __r =
            unsafe { mylib_text_buffer_flush(self.0, &mut __err as *mut *mut core::ffi::c_void) };
        if __r == 0 {
            Ok(())
        } else {
